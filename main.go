...
var ReadRoutes = map[string]http.HandlerFunc{
	...
	"/api/v1/registry/{project}/units/{name}/versions/":                           handlers.GetApplicationVersionsHandler,
	"/api/v1/registry/{project}/units/{name}/versions/{version}/":                 handlers.GetVersionHandler,
